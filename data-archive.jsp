...
<!-- 	                        <li>
			...
			<div id="page-wrapper" data-ng-app="">
				<div class="container-fluid">
	 	            <div class="row">
	                    <div class="col-lg-12">
	                        <h1 class="page-header">CMIP5 models and modelling institutes (updated daily)</h1>
	                    </div>
			            ...
			            <div class="col-lg-12 col-md-12">
			            	<div class="col-lg-6 col-md-6" data-ng-controller="cmip5ModelController">
				        		<div class="panel panel-info">
				                    ...
				                    <br>
				                    <br>
				                    	<table id="myTable5" class="table table-fixed3 tablesorter">
		                                    <thead>
		                                        <tr class="">
				        	...
				        	<div class="col-lg-6 col-md-6" data-ng-controller="cmip5InstituteController">
				            	<div class="panel panel-info">
				                    ...
				                    <br>
				                    <br>
			                        	<table id="myTable6" class="table table-fixed3 tablesorter">
		                                    <thead>
		                                        <tr class="">
 	 	                                            <th class="col-xs-1"># <i class="fa fa-sort"></i></th>
