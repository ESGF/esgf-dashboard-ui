...
<html lang="en">
	...
	<head>	
		...
		<style>
/* 		.jumboheaderImg {
			background-image: url('https://esgf.llnl.gov/media/images/logos/ESGF_Modeling_01.png');
...
<!-- 	                        <li>
	                            <a href="rating.html"><i class="fa fa-star-o fa-fw"></i> Rate your experience</a>
	                        </li> -->
	                    </ul>
	                </div>
            	</div>
		                   	...
		                   	<div class="well well-lg">
		                        <div class="row">
		                            <div class="col-xs-12 text-center">
		                             ...
		                             <div class="col-xs-12 text-center">
		                             <br>
	                                    <div class="huge2" id="projectsPanel"></div>
	                                    <div>Projects</div>
	                                </div>
	                            </div>
		                    </div>
	                    ...
	                    <div class="col-lg-2"> 
		                    <div class="well well-lg">
	                        	<div class="row">
	                        	    ...
	                        	    <div class="col-xs-12 text-center">
	                        	    <br>
	                                    <div class="huge2" id="countriesPanel"></div>
	                                    <div>Countries</div>
	                                </div>
	                            </div>
	                    	</div>
...
<!-- 	                  	<div class="col-lg-2"> 
		                    <div class="well well-lg">
		                        <div class="row">
		                             ...
		                             <div class="col-xs-12 text-center">
		                             <br>
	                                    <div class="huge" id="institutesPanel"></div>
	                                    <div>Institutes</div>
	                                </div>
	                            </div>
		                    </div>
		                   	...
		                   	<div class="well well-lg">
		                        <div class="row">
		                            <div class="col-xs-12 text-center">
		                             ...
		                             <div class="col-xs-12 text-center">
		                             <br>
	                                    <div class="huge2" id="datanodesPanel"></div>
	                                    <div>Data nodes</div>
	                                </div>
	                            </div>
		                    </div>
		                   	...
		                   	<div class="well well-lg">
		                        <div class="row">
		                            <div class="col-xs-12 text-center">
		                             ...
		                             <div class="col-xs-12 text-center">
		                             <br>
	                                    <div class="huge2" id="datasetsPanel"></div>
	                    ...
	                    <div class="col-lg-2">                     
		                    <div class="well well-lg">
		                    	<div class="row">
								    ...
								    <div class="col-xs-12 text-center">
								    <br>
	                                    <div class="huge2" id="downloadsPanel"></div>
		                   	...
		                   	<div class="well well-lg">
		                        <div class="row">
		                            <div class="col-xs-12 text-center">
		                             ...
		                             <div class="col-xs-12 text-center">
		                             <br>
	                                    <div class="huge2" id="downloadedDataPanel"></div>
...
<!--                     <div class="row">
               			<div class="col-lg-12">
		                    ...
		                    <div class="">
		                    	<br>
		                    	<br>
								<h3 class="text-center" style="padding-bottom: 5px;"><small>The statistics refer to a period starting from January 2018.</small></h3>
		                    </div>
