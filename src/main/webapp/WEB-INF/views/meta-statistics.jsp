	...
	<div id="wrapper">
        ...
        <div id="page-wrapper" data-ng-app="">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Meta-statistics</h1>
					 </div>
	                <div class="col-lg-12">	
	                	<div class="col-lg-12">
			            	<h2 class="page-header">Who visited this site?</h2>
			            </div>
	                	<div align="center">
	                		<iframe width="1000" height="910" src="https://datastudio.google.com/embed/reporting/****code_here****" frameborder="0" style="border:0" allowfullscreen></iframe>
	                	</div>
	                </div>
                </div>
            </div>
