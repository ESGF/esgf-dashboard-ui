                ...
                <div class="row">
                    <div class="col-lg-12">
				     ...
				     <div class="col-lg-12 col-md-12" data-ng-controller="isenes3DownloadsController">
	                     	...
	                     	<h4 class="page-header">The metrics in this page relate to the following IS-ENES3 institutions: BSC, CEDA, CMCC, CNRM, DKRZ, IPSL, LIU, UNICAN. <br><br> Successful downloads and downloaded data volumes KPIs are updated on a weekly basis. The distinct clients KPI is updated every 6 months.</h4>
