function loadcordex($scope, $http) {
    ...
    $scope.exportDatasets = function () {
    	...
    	window.open('/esgf-dashboard-ui/loadCordexDataset?hostname=' + hostname);
    };
    
    $scope.exportAllVariables = function () {
    	var hostname = $scope.slctItem4.name;
    	window.open('/esgf-dashboard-ui/loadCordexVariable?hostname=' + hostname);
    };
    
    $scope.exportDomain = function () {
    	var hostname = $scope.slctItem4.name;
    	window.open('/esgf-dashboard-ui/loadCordexDomain?hostname=' + hostname);
    };
    
    $scope.exportDrivingModel = function () {
    	var hostname = $scope.slctItem4.name;
    	window.open('/esgf-dashboard-ui/loadCordexDrivingModel?hostname=' + hostname);
    };
    
    $scope.exportRCM = function () {
    	var hostname = $scope.slctItem4.name;
    	window.open('/esgf-dashboard-ui/loadCordexRCM?hostname=' + hostname);
    };
	 ...
	 $scope.exportContinentCountry = function () {
		...
		if (countryContinent == 'continent') {
			window.open('/esgf-dashboard-ui/downloadCSVbyContinent?project=CORDEX&datanode=' + datanode);
		}
		else if (countryContinent == 'country') {
			window.open('/esgf-dashboard-ui/downloadCSVbyCountry?project=CORDEX&datanode=' + datanode);
		}		
	 }
