function loadObs4mips($scope, $http) {	
	...
	$scope.exportTopDatasets = function () {
		...
		window.open('/esgf-dashboard-ui/loadObs4MIPsDataset?hostname=' + hostname);
	};
	 
 	 $scope.exportSource = function () {
		 var hostname = $scope.slctItem4.name;
		 window.open('/esgf-dashboard-ui/loadObs4MIPsSource?hostname=' + hostname);
	 };
	 
 	 $scope.exportAllVariables = function () {
		 var hostname = $scope.slctItem4.name;
		 window.open('/esgf-dashboard-ui/loadObs4MIPsVariable?hostname=' + hostname);
	 };
	 
 	 $scope.exportRealm = function () {
		 var hostname = $scope.slctItem4.name;
		 window.open('/esgf-dashboard-ui/loadObs4MIPsRealm?hostname=' + hostname);
	 };
	 ...
	 $scope.exportContinentCountry = function () {
		...
		if (countryContinent == 'continent') {
			window.open('/esgf-dashboard-ui/downloadCSVbyContinent?project=OBS4MIPS&datanode=' + datanode);
		}
		else if (countryContinent == 'country') {
			window.open('/esgf-dashboard-ui/downloadCSVbyCountry?project=OBS4MIPS&datanode=' + datanode);
		}		
	 }
