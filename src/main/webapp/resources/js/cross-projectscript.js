...
/*       {id: '3',
    ...
    $scope.update2 = function () {
        ...
        $http.get("/esgf-dashboard-ui/getCrossProjectStats", {params: {continent: "00", measure : $scope.slctItem1, groupby: "project", datanode : $scope.slctItem2.name}}).success(
      	      function(data, status, headers, config) {
        ...
        $http.get("/esgf-dashboard-ui/getCrossProjectStats", {params: {continent: "00", measure : $scope.slctItem1, groupby: "time", datanode : $scope.slctItem2.name}}).success(
        	      function(data, status, headers, config) {
          ...
          $http.get("/esgf-dashboard-ui/getCrossProjectStats", {params: {continent: "00", measure : $scope.slctItem1, groupby: "host", datanode : $scope.slctItem2.name}}).success(
          	      function(data, status, headers, config) {
    ...
    $scope.update = function () {
        ...
        $http.get("/esgf-dashboard-ui/getCrossProjectStats", {params: {continent: "00", measure : $scope.slctItem1, groupby: "project", datanode : "all"}}).success(
        	      function(data, status, headers, config) {
        ...
        $http.get("/esgf-dashboard-ui/getCrossProjectStats", {params: {continent: "00", measure : $scope.slctItem1, groupby: "time", datanode : "all"}}).success(
      	      function(data, status, headers, config) {
        ...
        $http.get("/esgf-dashboard-ui/getCrossProjectStats", {params: {continent: "00", measure : $scope.slctItem1, groupby: "host", datanode : "all"}}).success(
        	      function(data, status, headers, config) {
