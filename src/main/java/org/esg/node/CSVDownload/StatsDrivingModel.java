...
public class StatsDrivingModel implements Serializable {

	private static final long serialVersionUID = 1L;
	
	private String driving_model = null;
	...
	public void setDriving_model(String driving_model) {
		this.driving_model = driving_model;
	}
