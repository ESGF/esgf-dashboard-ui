...
public class GetClientsByContinentAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			stmt = conn.prepareStatement(SqlQuery.GET_CLIENTS_BY_CONTINENT.getSql());
			...
			while (rs.next()) {
				...
				geoclient.setLabel(rs.getString("continent"));
				geoclient.setData(rs.getInt("numclients"));
