...
public class LoadLastUsersDataByUserAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			if (limitvalue.equals("10"))
				stmt = conn.prepareStatement(SqlQuery.GET_LAST_USERS_10.getSql());
			else if (limitvalue.equals("50"))
				stmt = conn.prepareStatement(SqlQuery.GET_LAST_USERS_50.getSql());
			else if (limitvalue.equals("100"))
				stmt = conn.prepareStatement(SqlQuery.GET_LAST_USERS_100.getSql());
