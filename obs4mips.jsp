...
<head>
    ...
    <style>
    	...
    	#map { height: 500px }
    	#variablePanel { height:450px; padding-bottom:40px;} 
    	#sourcePanel { height:450px; padding-bottom:40px;} 
    ...
    <script src="<c:url value="/resources/js/obs4mipsscript.js"/>"></script>  
...
<!--                         <li>
        ...
        <div id="page-wrapper" data-ng-app="">
            <div class="container-fluid">
                <div class="row" data-ng-controller="loadObs4mips">
                    <div class="col-lg-12">
                        <h1 class="page-header">obs4MIPs project</h1>
...
<!--                         	 <div class="pull-right">
					    ...
					    <div class="col-lg-12 col-md-12">
					        <br>
					    	<h6 id="lastUpdate" align="right">Last update: 02/09/2022</h6>
					    </div>
					 </div>
				     <div class="col-lg-12 col-md-12">				    
...
<!-- 		                    <div class="panel panel-danger">
		                        	...
		                        	<table class="table table-fixed2">
	                                    <thead>
	                                        <tr class="">
	                                            ...
	                                            <th class="col-xs-10">Dataset name</th>
	                                    ...
	                                    <tbody id="datasetTable">
	                                    	<tr ng-repeat="a in datasetRows">
	                                    		...
	                                    		<td class="col-xs-10"><span data-toggle="{{a.dimension}}" title="{{a.dimension}}">{{a.dimension}}</span></td>
	                                    		<td class="col-xs-1"><span data-toggle="{{a.measure}}" title="{{a.measure}}">{{a.measure}}</span></td>
	                                    	</tr>
	                                    </tbody>
	                                 </table>
		                        </div>
		                    ...
		                    <div class="panel panel-danger">
		                        <div class="panel-heading">
		                            <i class="fa fa-files-o fa-fw"></i> Top ten realms 
		                        </div>
		                        <div class="panel-body" style="height: 450px">
	                                <button ng-click="exportRealm()" style="float: right;" title="Exports the FULL list in a CSV file">Export CSV</button>
	                                <table class="table table-fixed2">
	                                    <thead>
	                                        <tr class="">
	                                        	<th class="col-xs-2">#</th>
	                                        	<th class="col-xs-7">Realm</th>
	                                            <th class="col-xs-3">Value</th>
	                                        </tr>
	                                    </thead>
	                                    <tbody id="topTenRealmTable">
 	                                    	<tr ng-repeat="e in topTenRealmRows">
 	                                    		<td class="col-xs-2">{{$index + 1}}</td>
 	                                    		<td class="col-xs-7"><span data-toggle="{{e.dimension}}" title="{{e.dimension}}">{{e.dimension}}</span></td>
	                                    		<td class="col-xs-3"><span data-toggle="{{e.measure}}" title="{{e.measure}}">{{e.measure}}</span></td>
	                                    	</tr>
	                                ...
	                                <table class="table table-fixed4">
	                                    <thead>
	                                        <tr class="">
	                                            ...
	                                            <th class="col-xs-6">Variable long name</th>
			            ...
			            <div class="col-lg-12">                        
		                     <div class="panel panel-warning">
		                        <div class="panel-heading" id="panel-variable">
		                            <i class="fa fa-bar-chart fa-fw"></i> Number of downloads by realm
		                        </div>
	                    ...
	                    <div class="col-lg-12">                        
		                     <div class="panel panel-info">
		                        <div class="panel-heading" id="panel-source">
		                            <i class="fa fa-bar-chart fa-fw"></i> Number of downloads by source
		                        </div>
		                        <div class="panel-body">  
		                        	<button ng-click="exportSource()" style="float: right;" title="Exports the FULL list in a CSV file">Export CSV</button>
		                        	<br>
