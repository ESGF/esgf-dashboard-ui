    ...
    $http.get("/esgf-dashboard-ui/getDataNodes", {params: {project: "cmip5"}}).success(
	 ...
	 var lastUpdate = text.substring(13,23);
 	 ...
 	 $scope.exportTopDatasets = function () {
		 ...
		 window.open('/esgf-dashboard-ui/loadCMIP5Dataset?hostname=' + hostname + '&lastUpdate=' + lastUpdate);
	 };
	 
 	 $scope.exportExperiment = function () {
		 var hostname = $scope.slctItem4.name;
		 window.open('/esgf-dashboard-ui/loadCMIP5Experiment?hostname=' + hostname + '&lastUpdate=' + lastUpdate);
	 };
	 
 	 $scope.exportAllVariables = function () {
		 var hostname = $scope.slctItem4.name;
		 window.open('/esgf-dashboard-ui/loadCMIP5Variable?hostname=' + hostname + '&lastUpdate=' + lastUpdate);
	 };
	 
 	 $scope.exportModel = function () {
		 var hostname = $scope.slctItem4.name;
		 window.open('/esgf-dashboard-ui/loadCMIP5Model?hostname=' + hostname + '&lastUpdate=' + lastUpdate);
	 };
	 ...
	 $scope.exportContinentCountry = function () {
		...
		if (countryContinent == 'continent') {
			window.open('/esgf-dashboard-ui/downloadCSVbyContinent?project=CMIP5&datanode=' + datanode + '&lastUpdate=' + lastUpdate);
		}
		else if (countryContinent == 'country') {
			window.open('/esgf-dashboard-ui/downloadCSVbyCountry?project=CMIP5&datanode=' + datanode + '&lastUpdate=' + lastUpdate);
		}		
	 }
