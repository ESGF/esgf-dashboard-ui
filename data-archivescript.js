...
var lastUpdate = date.slice(8, 10) + '/' + date.slice(5, 7) + '/' + date.slice(0, 4);
...
function cmip5ModelController($scope, $http) {	
	...
	$scope.exportModel = function () {
		window.open('/esgf-dashboard-ui/loadCMIP5Published?facet=model&lastUpdate=' + lastUpdate);
	}; 
}
...
function cmip5InstituteController($scope, $http) {
	...
	$scope.exportInstitute = function () {
		window.open('/esgf-dashboard-ui/loadCMIP5Published?facet=institute&lastUpdate=' + lastUpdate);
	}; 
}
...
function cmip6ModelController($scope, $http) {	
	...
	$scope.exportModel = function () {
		window.open('/esgf-dashboard-ui/loadCMIP6Published?facet=model&lastUpdate=' + lastUpdate);
	}; 
}
...
function cmip6InstituteController($scope, $http) {
	...
	$scope.exportInstitute = function () {
		window.open('/esgf-dashboard-ui/loadCMIP6Published?facet=institute&lastUpdate=' + lastUpdate);
	}; 
}
...
function cordexModelController($scope, $http) {	
	...
	$scope.exportDrivingModel = function () {
		window.open('/esgf-dashboard-ui/loadCordexPublished?facet=driving_model&lastUpdate=' + lastUpdate);
	}; 
}
...
function cordexInstituteController($scope, $http) {
	...
	$scope.exportInstitute = function () {
		window.open('/esgf-dashboard-ui/loadCordexPublished?facet=institute&lastUpdate=' + lastUpdate);
	}; 
}
...
function cordexDomainController($scope, $http) {
	...
	$scope.exportDomain = function () {
		window.open('/esgf-dashboard-ui/loadCordexPublished?facet=domain&lastUpdate=' + lastUpdate);
	}; 
}
...
function cordexRcmController($scope, $http) {
	...
	$scope.exportRCM = function () {
		window.open('/esgf-dashboard-ui/loadCordexPublished?facet=rcm&lastUpdate=' + lastUpdate);
	}; 
}