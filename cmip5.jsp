...
<head>
    ...
    <style>
    	#experimentPanel { height:450px; padding-bottom:40px;}
    	#modelPanel { height:450px; padding-bottom:40px;}      	
...
/* 		  display: inline-block; */
    ...
    <script src="<c:url value="/resources/js/cmip5script.js"/>"></script>  
...
<!-- 			                    <div class="panel panel-success">
			                    ...
			                    <div class="panel panel-success">
			                        <div class="panel-heading">
			                            <i class="fa fa-files-o fa-fw"></i> Top ten models
			                        </div>
			                        
			                        <div class="panel-body" style="height: 450px">
			                        <button ng-click="exportModel()" style="float: right;" title="Exports the FULL list in a CSV file">Export CSV</button>
			                        ...
			                        <table class="table table-fixed2">
	                                    ...
	                                    <tbody id="topTenModelTable">
 	                                    	<tr ng-repeat="e in topTenModelsRows">
			                        ...
			                        <table class="table table-fixed4">
	                                    <thead>
	                                    	<tr class="">
	                                            ...
	                                            <th class="col-xs-5">Long name</th>
	                                    ...
	                                    <tbody id="variableTable">
 	                                    	<tr ng-repeat="e in variableRows">
	                                    		...
	                                    		<td class="col-xs-5"><span data-toggle="{{e.variable_long_name}}" title="{{e.variable_long_name}}">{{e.variable_long_name}}</span></td>
		                    ...
		                    <div class="col-lg-12">                        
			                    <div class="panel panel-warning">
			                        <div class="panel-heading" id="panel-model">
			                            <i class="fa fa-bar-chart fa-fw"></i> Number of downloads by model
			                        </div>
			                        <div class="panel-body">  
			                        	<button ng-click="exportModel()" style="float: right;" title="Exports the FULL list in a CSV file">Export CSV</button>
			                        	<br>
